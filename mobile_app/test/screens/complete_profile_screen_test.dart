...
void main() {
  ...
  group('CompleteProfileScreen', () {
    testWidgets('renders email from AuthService current user', (tester) async {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.enterText(
          find.byKey(const Key('unitNumberField')),
          'A-99-99',
        );
        await tester.tap(find.text('Continue'));
        await tester.pumpAndSettle();
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        var doc = await fakeFirestore.collection('users').doc('test-uid').get();
        expect(
          doc.data()!['unitNumber'],
          isNull,
